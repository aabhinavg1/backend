...
class OracleQuery {
 ...
 public:
  ...
  std::vector<OracleObject> get_more(const std::string_view &condition = "");

  template <primary_key_type T>
  std::optional<OracleObject> get(T &&primary_key);

  std::optional<OracleObject> get_wtih_condition(const std::string_view &condition);
  ...
  std::size_t execute_update(const std::string_view &sql);

  oracle::occi::Ref<OracleObject> execute_query_ref(const std::string_view &sql);

  std::vector<oracle::occi::Ref<OracleObject>> execute_query_ref_array(const std::string_view &sql);
};
...
template <object_base OracleObject>
inline std::vector<OracleObject> OracleQuery<OracleObject>::get_more(const std::string_view &condition) {
  oracle::occi::Statement *stmt =
...
template <object_base OracleObject>
inline std::optional<OracleObject> OracleQuery<OracleObject>::get_wtih_condition(const std::string_view &condition) {
...
template <object_base OracleObject>
std::size_t OracleQuery<OracleObject>::execute_update(const std::string_view &sql) {
...
template <object_base OracleObject>
oracle::occi::Ref<OracleObject> OracleQuery<OracleObject>::execute_query_ref(const std::string_view &sql) {
